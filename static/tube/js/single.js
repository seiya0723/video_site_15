window.addEventListener("load" , function (){
    ...
    //type=textで.allow_submitがついていないものは、Enterを押してもsubmitしない
    ...
    //$(document).on("click","#reply_to_comment",function(){ reply_to_comment_submit(); });
    //reply_to_comment_form_initialize();
...
/*
function reply_to_comment_submit() {

    let form_elem   = "#reply_form";
    ...
    $.ajax({
        ...
        if (data.error){
            $("#reply_to_comment_message").addClass("upload_message_error");
            $("#reply_to_comment_message").removeClass("upload_message_success");
        }
        else{
            $("#reply_to_comment_message").addClass("upload_message_success");
            $("#reply_to_comment_message").removeClass("upload_message_error");
            reply_to_comment_form_initialize();

            $("#reply_comment_area").html(data.content);
        }

        $("#reply_to_comment_message").text(data.message)
...
function reply_to_comment_form_initialize() {
    $("[name='content']").val("");
}
*/
