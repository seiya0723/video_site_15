...
class Video(models.Model):
    ...
    #good         = models.ManyToManyField(settings.AUTH_USER_MODEL, through="GoodVideo", through_fields=('user','target'), related_name="favorite_video",verbose_name="いいね", blank=True)
